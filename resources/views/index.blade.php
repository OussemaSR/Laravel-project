  ...
  <head>
    ...
    <header class="header-area header-sticky">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav" href="/">
                        <!-- ***** Logo Start ***** -->
                        <a class="navbar-brand" href="/">
                            <img src="images/logo.jpg" style="width:70px; height:70px; border-radius:50%"class="d-inline-block  align-bottom"alt="">
                        ...
                        <ul class="nav">
                            ...
                            <li class="scroll-to-section"><a href="#about">Choisir un projet</a></li>
                            <li class="scroll-to-section"><a href="#services">Comment ca marche</a></li>
                            <li class="scroll-to-section"><a href="#frequently-question">A propos</a></li>
                            <li class="scroll-to-section"><a href="#frequently-question">project en cours</a></li>
                            <li class="submenu">
                                <a href="javascript:;">Suite</a>
                                <ul>
            ...
            <div class="container">
                <div class="row">
                    <div class="left-text col-lg-6 col-md-6 col-sm-12 col-xs-12" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                        <h1><strong>SM DEVIS</strong></h1>
                        <h2>la Solution pour vos travaux !</h2>
                        <h3>- Accompagnement et suivi du projet</h3>
                        <h3>- Mise en relation avec des artisans qualifiées</h3> 
                        <h3>- Rénovation complète de vos habitations</h3>
                        ...
                        <a href="/try" class="main-button-slider">choisir mon project</a>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" data-scroll-reveal="enter right move 30px over 0.6s after 0.4s">
                        <img src="assets/images/office.png" class="rounded img-fluid d-block mx-auto" alt="First Vector Graphic">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="owl-carousel owl-theme">
                    <div class="item service-item">
                        ...
                        <i><img src="images/project/window.jpg" alt=""></i>
